...
10. [~] Akt 2 schreiben (Ricci-Fluss-Werkzeuge) – 5/7 Artikel ausformuliert (Stand 2026-04-27): 01 Riemannsche Metrik, 02 Krümmung und Ricci-Tensor, 03 Hamiltons Ricci-Fluss, 04 Singularitäten/Blow-up-Limits (Typ-I/II/III, Neckpinch, parabolisches Reskalieren, Hamilton-Kompaktheit, antike $\kappa$-Lösungen, Solitonen), 05 Perelman-Entropie ($\mathcal{F}$, $\mathcal{W}$, $\lambda/\mu/\nu$-Funktionale, Monotonie-Formel, konjugierte Wärmegleichung) – jeweils DE+EN. Offen: 06 κ-Nichtkollaps, 07 Reduzierte Länge sowie `ricci-fluss/index.md`. Quellen Lee 2018, Morgan-Tian 2007, Hamilton 1982/1995, Chow-Knopf 2004, Perelman 0211159, Kleiner-Lott 2008, Cao-Zhu 2006, Topping 2006, Angenent-Knopf 2004; mkdocs build --strict grün (0 Warnings).
