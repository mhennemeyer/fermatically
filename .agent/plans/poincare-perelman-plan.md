...
11. [~] Akt 3 schreiben (Der Beweis) – 2/6 Artikel ausformuliert (Stand 2026-04-27): 01 Hamiltons Programm und seine Hindernisse (Vision 1982, Vier-Schritte-Programm, Werkzeug-Tabelle bis 2002, fünf Hindernisse H1–H5/O1–O5, Mapping zu Perelmans Beiträgen, Roadmap), 02 Singularitätsanalyse Dimension 3 (Hamilton–Ivey-Pinching, Klassifikation antiker $\kappa$-Lösungen Dim 3 nach 0211159 §11, Modelltabelle Hals/Kappe/Raumform, kanonischer Nachbarschaftssatz §12.1 mit Beweisskizze, lokale Strukturzerlegung, Übergabe an Surgery). Frontmatter `stub` → `draft` in 4 Dateien. Quellen: Hamilton 1982/1993/1995/1997, Ivey 1993, Perelman 0211159/0303109/0307245, Morgan-Tian 2007, Kleiner-Lott 2008, Cao-Zhu 2006, Chow-Lu-Ni 2006. Offen: 03 Chirurgie, 04 Long-time-Verhalten, 05 Endliche Extinktion, 06 Poincaré aus Geometrisierung, `beweis/index.md`. mkdocs build --strict grün (0 Warnings, 2.73 s).
