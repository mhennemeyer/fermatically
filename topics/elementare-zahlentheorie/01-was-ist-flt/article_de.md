...
| Thema | Beschreibung |
|-------|-------------|
| [Potenzen und Polynome](../../vorwissen/potenzen-polynome/article_de.md) | Potenzschreibweise $a^n$ und Rechenregeln |
| [Zahlenbereiche](../../vorwissen/zahlenbereiche/article_de.md) | $\mathbb{N}, \mathbb{Z}, \mathbb{Q}, \mathbb{R}, \mathbb{C}$ und ihre Beziehungen |
| [Pythagoras und pythagoräische Tripel](../../vorwissen/pythagoras/article_de.md) | Der Satz von Pythagoras und ganzzahlige Lösungen von $a^2 + b^2 = c^2$ |
...
Es gibt keine drei positiven [ganzen Zahlen](../../vorwissen/zahlenbereiche/article_de.md) $x$, $y$ und $z$, die diese [Gleichung](../../vorwissen/gleichungen/article_de.md) für einen ganzzahligen [Exponenten](../../vorwissen/potenzen-polynome/article_de.md) $n \geq 3$ erfüllen.

Für $n = 2$ existieren dagegen unendlich viele Lösungen – die **[pythagoräische Tripel](../../vorwissen/pythagoras/article_de.md)**:

$$
3^2 + 4^2 = 5^2, \quad 5^2 + 12^2 = 13^2, \quad 8^2 + 15^2 = 17^2, \quad \ldots
$$

Der [Satz von Pythagoras](../../vorwissen/pythagoras/article_de.md) garantiert unendlich viele solcher Tripel, und sie lassen sich vollständig parametrisieren. Beim Übergang von Exponent $2$ zu $3$ verschwinden sämtliche Lösungen.
...
| Artikel | Thema |
|---------|-------|
| [02 – Der Beweis für $n = 4$](../02-beweis-n4/article_de.md) | Fermats Abstiegsmethode |
| [03 – Primzahlen und warum sie reichen](../03-primzahlen-reduktion/article_de.md) | Reduktion auf Primzahl-Exponenten |
| [04 – Der Beweis für $n = 3$](../04-beweis-n3/article_de.md) | Eulers Beweis und algebraische Zahlentheorie |
