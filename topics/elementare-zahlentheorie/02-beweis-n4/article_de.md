...
| [Beweisarten](../../vorwissen/beweisarten/article_de.md) | Widerspruchsbeweis und vollständige Induktion |
| [Gleichungen](../../vorwissen/gleichungen/article_de.md) | Äquivalente Umformungen |
| [Pythagoras und pythagoräische Tripel](../../vorwissen/pythagoras/article_de.md) | $a^2 + b^2 = c^2$ und ganzzahlige Lösungen |
| [Modulare Arithmetik](../../vorwissen/modulare-arithmetik/article_de.md) | Kongruenzen und Paritätsargumente |

---

## 1. Die Methode des unendlichen Abstiegs

Der **unendliche Abstieg** (*descente infinie*) ist eine [Beweistechnik](../../vorwissen/beweisarten/article_de.md), die Fermat selbst entwickelte. Die Grundidee:
...
Für den Beweis des Falls $n = 4$ ist ein klassisches Ergebnis erforderlich: die vollständige Beschreibung aller Lösungen von $x^2 + y^2 = z^2$ (siehe [Pythagoras und pythagoräische Tripel](../../vorwissen/pythagoras/article_de.md)).

**Satz (Parametrisierung der pythagoreischen Tripel).** Alle *primitiven* pythagoreischen Tripel $(x, y, z)$ mit $\gcd(x, y) = 1$ ([teilerfremd](../../vorwissen/teilbarkeit-ggt/article_de.md)) und $x$ gerade haben die Form:

$$
x = 2st, \quad y = s^2 - t^2, \quad z = s^2 + t^2
$$

wobei $s > t > 0$, $\gcd(s, t) = 1$ und $s \not\equiv t \pmod{2}$ (also $s$ und $t$ verschiedener [Parität](../../vorwissen/modulare-arithmetik/article_de.md)).
