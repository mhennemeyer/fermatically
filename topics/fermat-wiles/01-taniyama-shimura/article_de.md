...
Die Frey-Kurve, die aus einer hypothetischen FLT-Lösung konstruiert wird, ist semistabil. Daher genügt die semistabile Version der TSV, um Fermats letzten Satz zu beweisen – mehr war nicht nötig. Die Details dieser Reduktion sind Gegenstand des [nächsten Artikels](../02-frey-ribet/article_de.md).
...
| Artikel | Thema |
|---------|-------|
| [02 – Freys Idee und Ribets Theorem](../02-frey-ribet/article_de.md) | Wie eine FLT-Lösung zur „unmöglichen" Frey-Kurve führt |
| [03 – Galois-Darstellungen](../03-galois-darstellungen/article_de.md) | Wie Wiles Modularität in die Sprache der Darstellungen übersetzt |
