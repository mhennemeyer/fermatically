...
- [Deformation Theory](../04-deformationstheorie/article_en.md) – universal deformation ring $R$, Hecke algebra $T$, surjection $R \twoheadrightarrow T$
...
The successful proof of the upper bound uses the **Taylor–Wiles trick** (patching argument), which is presented in detail in the [next article](../06-taylor-wiles-trick/article_en.md). The basic idea: instead of estimating the Selmer group directly, one constructs a family of auxiliary situations in which the bound holds "in the limit" – and transfers it to the original case.
...
| Article | Topic |
|---------|-------|
| [06 – The Taylor–Wiles Trick](../06-taylor-wiles-trick/article_en.md) | The patching argument and the story of the gap |
| [07 – The 3-5 Switch](../07-3-5-switch/article_en.md) | How Langlands–Tunnell provides the starting point |
