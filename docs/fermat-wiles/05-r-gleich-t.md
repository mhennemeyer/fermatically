...
- [Deformationstheorie](04-deformationstheorie.md) – Universeller Deformationsring $R$, Hecke-Algebra $T$, Surjektion $R \twoheadrightarrow T$
...
Der erfolgreiche Beweis der oberen Schranke nutzt den **Taylor-Wiles-Trick** (Patching-Argument), der im [nächsten Artikel](06-taylor-wiles-trick.md) ausführlich dargestellt wird. Die Grundidee: Statt die Selmer-Gruppe direkt abzuschätzen, konstruiert man eine Familie von Hilfs-Situationen, in denen die Schranke „im Limes" gilt – und überträgt sie auf den Ausgangsfall.
...
| Artikel | Thema |
|---------|-------|
| [06 – Der Taylor-Wiles-Trick](06-taylor-wiles-trick.md) | Das Patching-Argument und die Geschichte der Lücke |
| [07 – Der 3-5-Switch](07-3-5-switch.md) | Wie Langlands-Tunnell den Einstieg liefert |
